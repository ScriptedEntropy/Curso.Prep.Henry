...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  var arrayu = usuario.amigos
  arrayu.push(nuevoAmigo)
  return usuario
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  var postsarr = usuario.posts
  var acc = 0
  for(let i = 0; i < postsarr.length; i++){
    acc = acc + postsarr[i].likes
  }
  return acc
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.calcularPrecioDescuento = function calcularPrecioDescuento(){
    var calculo = producto.precio * producto.porcentajeDeDescuento
    return producto.precio - calculo
  }
  return producto
